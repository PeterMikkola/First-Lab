<?php  include "includes/db.php"; ?>
 ...
 ?>
    ...
    if(isset($_SESSION['username']) && is_admin($_SESSION['username']) ) {
        ...
        $stmt2 = mysqli_prepare($connection , "SELECT post_title, post_author, post_date, post_image, post_content FROM posts WHERE post_id = ? ");
...
<?php include "includes/footer.php";?>
        ...
        <script>
            $(document).ready(function(){
                ...
                $('.like').click(function(){
                    $.ajax({
                        url: "/cms-3/post.php?p_id=<?php echo $the_post_id; ?>",
                        type: 'post',
                        data: {
                            'liked': 1,
                            'post_id': post_id,
